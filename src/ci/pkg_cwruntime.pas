...
uses
  cwlog.console, cwLog, cwTest, cwTest.Standard, cwTypes, cwUnicode, 
  cwUnicode.Standard, cwCollections, cwCollections.Standard, cwDynLib, 
  cwDynLib.Standard, cwCollections.Stack.Standard, 
  cwCollections.StringList.Standard, cwLog.LogTarget.Console, 
  cwTest.TestCase.Console, cwtest.testreport.console, cwtest.testsuite.custom, 
  cwTest.TestSuite.Delphi, cwTest.TestSuite.Fpc, cwUnicode.Codec.Standard, 
