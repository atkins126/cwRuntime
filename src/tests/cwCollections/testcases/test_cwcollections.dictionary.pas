...
begin
  CUT := TDictionary<string,string>.Create(TCompare.CompareString,2,FALSE,FALSE);
  internal_ForEach(CUT);
  CUT := TDictionary<string,string>.Create(TCompare.CompareString,2,FALSE,TRUE);
  internal_ForEach(CUT);
  CUT := TDictionary<string,string>.Create(TCompare.CompareString,2,TRUE,FALSE);
  internal_ForEach(CUT);
  CUT := TDictionary<string,string>.Create(TCompare.CompareString,2,TRUE,TRUE);
  internal_ForEach(CUT);
  CUT := TDictionary<string,string>.Create(TCompare.CompareString,32,FALSE,FALSE);
  internal_ForEach(CUT);
  CUT := TDictionary<string,string>.Create(TCompare.CompareString,32,FALSE,TRUE);
  internal_ForEach(CUT);
  CUT := TDictionary<string,string>.Create(TCompare.CompareString,32,TRUE,FALSE);
  internal_ForEach(CUT);
  CUT := TDictionary<string,string>.Create(TCompare.CompareString,32,TRUE,TRUE);
  internal_ForEach(CUT);
end;
...
begin
  ...
  CUT['C'] := '3';
  // Act:
  CUT.ForEach(TEnumeratePair<string,string>.Create(HandleForEach));
  // Assert:
...
var
  CUT: IDictionary<string,uint32>;
begin
  CUT := TDictionary<string,uint32>.Create(TCompare.CompareString,2,FALSE,FALSE);
  internal_getCount(CUT);
  CUT := TDictionary<string,uint32>.Create(TCompare.CompareString,2,FALSE,TRUE);
  internal_getCount(CUT);
  CUT := TDictionary<string,uint32>.Create(TCompare.CompareString,2,TRUE,FALSE);
  internal_getCount(CUT);
  CUT := TDictionary<string,uint32>.Create(TCompare.CompareString,2,TRUE,TRUE);
  internal_getCount(CUT);
  CUT := TDictionary<string,uint32>.Create(TCompare.CompareString,32,FALSE,FALSE);
  internal_getCount(CUT);
  CUT := TDictionary<string,uint32>.Create(TCompare.CompareString,32,FALSE,TRUE);
  internal_getCount(CUT);
  CUT := TDictionary<string,uint32>.Create(TCompare.CompareString,32,TRUE,FALSE);
  internal_getCount(CUT);
  CUT := TDictionary<string,uint32>.Create(TCompare.CompareString,32,TRUE,TRUE);
  internal_getCount(CUT);
end;
