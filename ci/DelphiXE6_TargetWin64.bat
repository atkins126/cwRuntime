...
msbuild %WORKSPACE%\src\projects\lib_cwLog_XE6.dproj                      || exit /b

REM ------------------------------ Build test projects --------------------------

msbuild %WORKSPACE%\src\tests\cwCollections\test_cwCollections_XE6.dproj  || exit /b
msbuild %WORKSPACE%\src\tests\cwIO\test_cwIO_XE6.dproj                    || exit /b
msbuild %WORKSPACE%\src\tests\cwLog\test_dynamic_cwLog_XE6.dproj          || exit /b
msbuild %WORKSPACE%\src\tests\cwLog\test_static_cwLog_XE6.dproj           || exit /b
msbuild %WORKSPACE%\src\tests\cwTest\test_cwTest_XE6.dproj                || exit /b
msbuild %WORKSPACE%\src\tests\cwTypes\test_cwTypes_XE6.dproj              || exit /b
msbuild %WORKSPACE%\src\tests\cwUnicode\test_cwUnicode_XE6.dproj          || exit /b
msbuild %WORKSPACE%\src\tests\cwVectors\test_cwVectors_XE6.dproj          || exit /b
